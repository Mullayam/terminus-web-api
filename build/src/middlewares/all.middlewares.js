...
class AllMiddlewares {
    ...
    static isApiProtected(req, res, next) {
        logger_1.Logging.dev(`API Route ${req.originalUrl} is Protected`);
    ...
    static IRequestHeaders(req, res, next) {
        logger_1.Logging.dev("IRequestHeaders ID Initiated");
...
function ApplyMiddleware(middlewareFunction) {
